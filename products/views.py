...
class ProductDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx["review_count"] = reviews_qs.count()
        ctx["average_rating"] = reviews_qs.aggregate(avg=Avg("rating"))[
            "avg"
        ]
        ...
        if request.user.is_authenticated:
            ...
            if can_review:
                ...
                existing_review = getattr(provided_form, "instance", None) or ProductReview.objects.filter(
